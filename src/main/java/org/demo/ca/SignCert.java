...
public class SignCert {
	...
	private String mKeystore = "C:/tmp/keys/mykey.keystore"; // 密锁库路径
	...
	private String mSignedCert = "C:/tmp/keys/client.cer"; // 被签证书
	private String mNewCert = "C:/tmp/keys/clientSignKey.cer"; // 签发后的新证书全名
